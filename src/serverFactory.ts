...
import { PORT, BACKEND_URL, AUTH0_BASE_URL, ENABLE_MONITORING } from "@/server/utils/env";
...
export class ServerFactory {
    ...
    public async createApp() {
        ...
        if (ENABLE_MONITORING) {
            ...
            console.log(`setting up express app monitoring at http://localhost:${this.port}/status`)
